    ...
    return (
        <section className='text-14-bpl-white h-screen'>
            ...
            <div className='h-full flex justify-center items-center'>
                <div onClick={() => navigate('/addPlayers')} className='flex flex-col justify-center items-center border-2 border-14-bpl-cg-blue h-[350px] w-[350px] rounded-3xl cursor-pointer hover:scale-125 duration-300 hover:text-14-bpl-cg-blue'>
